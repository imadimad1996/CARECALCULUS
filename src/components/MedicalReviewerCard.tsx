      ...
      <div className="flex items-start gap-5 relative z-10">
        ...
        <div className="shrink-0 relative">
          {reviewer.avatarUrl ? (
            ...
            <div className="w-16 h-16 rounded-full bg-slate-200 dark:bg-slate-700 border-2 border-white dark:border-slate-600 shadow-sm flex items-center justify-center">
              <UserCheck className="w-8 h-8 text-slate-400 dark:text-slate-500" />
            </div>
          )}
          <div className="absolute -bottom-1 -right-1 bg-teal-500 rounded-full p-1 border-2 border-white dark:border-slate-900 shadow-sm" title="Verified Medical Reviewer">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-400 mb-3 leading-snug">
            {reviewer.role}
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            <div className="text-xs text-slate-500 dark:text-slate-500 font-medium">
              {t.lastUpdated[lang]} <span className="text-slate-700 dark:text-slate-300">{reviewer.lastReviewed}</span>
            </div>
            ...
            {reviewer.profileUrl && (
              reviewer.profileUrl.startsWith('/') ? (
                <Link 
                  ...
                  className="text-xs font-bold text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 flex items-center gap-1 transition-colors"
                >
                  {t.viewProfile[lang]}
