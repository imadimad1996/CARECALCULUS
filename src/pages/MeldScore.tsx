...
const translations: Translations = {
  en: {
    ...
    clinicalText: "MELD-Na ranges from 6 to 40. High scores reflect progressive hepatic synthetic failure. Clinical Pearl: Warfarin and DOACs artificially elevate INR without indicating true hepatocellular decline — always cross-check against albumin and bilirubin trends.",
    ...
    pillarText: [
      ...
      "A primary clinical limitation of bedside MELD-Na application is laboratory confounder sensitivity. Warfarin and DOACs inflate INR without reflecting intrinsic hepatocellular decline. In acute hepatorenal syndrome (HRS-AKI), serum creatinine routinely lags behind real-time GFR reduction due to sarcopenic muscle wasting in cirrhotic patients. Always correlate lab shifts against clinical volume status and urinary diagnostic indices — particularly urine sodium and fractional excretion of sodium."
    ],
  ...
  fr: {
    ...
    clinicalText: "Le MELD-Na varie de 6 à 40. Des scores élevés indiquent une gravité accrue. Note clinique : Les patients sous anticoagulants (ex. warfarine) présentent un INR artificiellement élevé, ce qui fausse le score MELD à la hausse ; de plus, chez les patients sarcopéniques, la créatinine sous-estime souvent la sévérité réelle de l'insuffisance rénale en raison de la perte de masse musculaire.",
    ...
    pillarText: [
      ...
      "Une limite clinique essentielle du MELD-Na est sa sensibilité aux facteurs confondants biologiques. La warfarine et les anticoagulants oraux directs augmentent l'INR sans indiquer de déclin hépatocellulaire intrinsèque. Dans le syndrome hépatorénal aigu (SHR-IRA), la créatinine sérique sous-estime fréquemment la chute réelle du DFG chez le cirrhotique sarcopénique, car la perte musculaire atténue l'élévation plasmatique attendue. Corréllez systématiquement les variations biologiques au statut volémique clinique et aux indices urinaires diagnostiques, notamment le sodium urinaire et la fraction d'excrétion du sodium."
    ],
  ...
  useEffect(() => {
    if (meldScore !== null && meldScore > 0) {
      const timer = setTimeout(() => {
        ...
        trackCalculatorResult('meld-score', meldScore, 'MELD-Na Score', lang);
      }, 1500);
