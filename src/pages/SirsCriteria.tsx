...
export default function SirsCriteria({ lang }: { lang: LangCode }) {
  ...
  return (
    <>
      ...
      <JsonLd path="/sirs-criteria" title="Clinical Decision Support — CareCalculus" description="Evidence-based medical decision support calculator." type="SoftwareApplication" />
