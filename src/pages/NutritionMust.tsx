...
export default function NutritionMust({ lang }: { lang: LangCode }) {
  ...
  return (
    <>
      ...
      <JsonLd path="/nutrition-must" title="Clinical Decision Support — CareCalculus" description="Evidence-based medical decision support calculator." type="SoftwareApplication" />
