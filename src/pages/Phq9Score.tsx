...
export default function Phq9Score({ lang }: { lang: LangCode }) {
  ...
  return (
    <>
      ...
      <JsonLd path="/phq9-score" title="Clinical Decision Support — CareCalculus" description="Evidence-based medical decision support calculator." type="SoftwareApplication" />
