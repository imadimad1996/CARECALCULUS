...
export default function DripRate({ lang }: { lang: LangCode }) {
  ...
  return (
    <>
      ...
      <JsonLd path="/drip-rate-calculator" title="Clinical Decision Support — CareCalculus" description="Evidence-based medical decision support calculator." type="SoftwareApplication" />
