...
const translations: Translations = {
  en: {
    ...
    pillarText: [
      ...
      "The principal bedside limitation of Child-Pugh scoring is inter-observer variability in its two clinical parameters. Ascites grading (mild vs. moderate/severe) hinges on diuretic responsiveness and ultrasound quantification. Hepatic encephalopathy staging relies on subjective interpretation under West Haven criteria — a notoriously inconsistent exercise between assessors. Critically: acute gastrointestinal hemorrhage and recent sedative administration can transiently mimic Grade III–IV hepatic encephalopathy without reflecting true hepatocellular synthetic failure. Score these clinical events with caution and re-evaluate after hemodynamic stabilization."
    ],
  },
  fr: {
