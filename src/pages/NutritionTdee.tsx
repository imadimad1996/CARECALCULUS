...
export default function NutritionTdee({ lang }: { lang: LangCode }) {
  ...
  return (
    <>
      ...
      <JsonLd path="/nutrition-tdee" title="Clinical Decision Support — CareCalculus" description="Evidence-based medical decision support calculator." type="SoftwareApplication" />
      ...
      <div className="mt-16 pt-10 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex items-start gap-4">
            <div className="p-3 min-h-[44px] min-w-[44px].5 bg-amber-50 text-amber-600 rounded-lg shrink-0">
