  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Because we collect no personal health data, patient privacy is preserved by design. If you wish to clear stored language/unit preferences, you may clear your browser local storage at any time.',
      },
    ],
  },
  fr: {
    ...
    intro: 'CareCalculus est conçu avec la confidentialité par défaut. Cette page explique quelles données nous collectons (très peu).',
    sections: [
      ...
      },
      {
        ...
        body: 'Parce que nous ne collectons aucune donnée de santé personnelle, la confidentialité est préservée par conception. Vous pouvez effacer le stockage local à tout moment via les paramètres de votre navigateur.',
      },
    ],
  },
};
