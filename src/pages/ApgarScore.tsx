...
export default function ApgarScore({ lang }: { lang: LangCode }) {
  ...
  return (
    <>
      ...
      <JsonLd path="/apgar-score" title="Clinical Decision Support — CareCalculus" description="Evidence-based medical decision support calculator." type="SoftwareApplication" />
