...
export default function CkdEpiGfr({ lang }: { lang: LangCode }) {
  ...
  return (
    <div className={`max-w-4xl mx-auto space-y-6 lg:space-y-8 ${isRtl ? 'rtl' : 'ltr'}`}>
      ...
      <JsonLd path="/ckd-epi-gfr" title="Clinical Decision Support — CareCalculus" description="Evidence-based medical decision support calculator." type="SoftwareApplication" />
