...
export default function TidalVolume({ lang }: { lang: LangCode }) {
  ...
  return (
    <>
      ...
      <JsonLd path="/tidal-volume" title="Clinical Decision Support — CareCalculus" description="Evidence-based medical decision support calculator." type="SoftwareApplication" />
