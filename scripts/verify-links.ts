...
function staticRoutes(): string[] {
  const paths = [
    ...
    '/nutrition-nrs2002', '/nutrition-hub', '/clinical-library', '/glp-1-hub',
    '/blog', '/blog-articles', '/cours', '/presentations', '/fmp-medecine', '/ispits',
    '/for-hospitals', '/embed-gallery', '/pricing', '/about', '/disclaimer',
    '/privacy', '/terms',
